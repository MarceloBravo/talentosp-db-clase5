### Diseño del Sistema de Inventario (5 minutos)
Análisis de requisitos y diseño de la base de datos para un sistema de inventario completo.
...
- alertas automáticas por email cuando el stock esté bajo, 
- interfaz web básica con HTML/CSS/JavaScript vanilla, 
- sistema de códigos de barras para productos, y 
- API de integración con sistemas externos (ERP, e-commerce).